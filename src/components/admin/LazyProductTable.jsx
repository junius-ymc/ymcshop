        ...
        <tbody className="divide-y divide-gray-200">
          {currentItems.map((item, index) => (
            <tr key={index} className="admin-table-tr-product">
              <td className="admin-table-td-product text-xs text-center">{indexOfFirstItem + index + 1}({item.id})</td>
              <td className="admin-table-td-product text-center justify-items-center">
              ...
              <td className="admin-table-td-product text-xs font-semibold text-center">{numberFormat(item.price)}</td>
              <td className="admin-table-td-product text-xs text-center">{item.quantity}</td>
              <td className="admin-table-td-product text-xs text-center">{item.sold}</td>
              <td className="admin-table-td-product text-xs text-center">{dateFormat(item.updatedAt)}</td>

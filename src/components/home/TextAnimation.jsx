...
const TextAnimation = () => {
  ...
  const texts = [
    '🙏 สวัสดีครับ คุณหนุ่ยนุ้ย ยินดีต้อนรับสู่ร้าน YMC Shop ✨🎉',
    '🥰 เราเป็นคนแรกที่หลงเข้ามาในเว็บนี้นะ 😝',
    '😮 ห๊าาา..อะไรนะ..!!! จะเหมาหมดร้านนี้เลยรึ 😆😆😆',
    '👉 ยินดีต้อนรับสู่ YMC Shop – แหล่งรวมเสื้อผ้าสไตล์ Streetwear และเครื่องแต่งกาย Vintage ที่คัดสรรมาเพื่อคนทันสมัยเช่นคุณ 👈',
    '🛠 ขณะนี้..เว็บไซต์เสร็จสมบูณร์แล้ว 95% และกำลังอยู่ในช่วงทดสอบระบบ ปรับปรุงและแก้ไข 😎',
